...
import { IncomeService } from 'src/app/income/services/income.service';
...
export class DashboardAnalyticsComponent implements OnInit {
  ...
  getIncomeStatistics = () =>
    this.incomeService.getIncomeStatistics().subscribe(
      (res: any) => {
        this.salesSeries.push(
          {
            name: 'دينار',
            data: res.incomes
          }
        ...
        this.incomeStats = res;
        for (const income of res.incomes) this.total += income
        
      }
    )

  getOrderStatistics = () => this.orderService.getOrderStatistics().subscribe(
    res => this.orderStatistic = res
  )
